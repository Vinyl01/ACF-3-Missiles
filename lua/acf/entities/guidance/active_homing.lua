...
local Guidance  = Guidances.Register("Active Homing", "GPS Guided")

if CLIENT then
	Guidance.Description = "This guidance package allows you to guide the missile to a desired point in the map."
else
	local ZERO = Vector()
